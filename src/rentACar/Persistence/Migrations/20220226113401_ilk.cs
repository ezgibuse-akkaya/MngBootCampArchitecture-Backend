        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicePoint = table.Column<byte>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FindexScore = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidDate = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionCodesId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentCityId = table.Column<int>(type: "integer", nullable: false),
                    ReturnCityId = table.Column<int>(type: "integer", nullable: false),
                    ReturnedCityId = table.Column<int>(type: "integer", nullable: true),
                    RentedKilometer = table.Column<int>(type: "integer", nullable: false),
                    ReturnedKilometer = table.Column<int>(type: "integer", nullable: false),
                    CarId = table.Column<int>(type: "integer", nullable: false),
                    CustomerId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalServiceRental", x => new { x.AdditionalServicesId, x.RentalsId });
                    table.ForeignKey(
                        name: "FK_AdditionalServiceRental_AdditionalServices_AdditionalServic~",
                        column: x => x.AdditionalServicesId,
                        principalTable: "AdditionalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdditionalServiceRental_Rentals_RentalsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalServiceRental_RentalsId",
                table: "AdditionalServiceRental",
                column: "RentalsId");
